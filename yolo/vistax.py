...
try:
    ...
    ser = None
    print("[WARNING] Serial port  connected. Using defaults.")
...
VIDEO_PATH = "C:/RHINO-CAR/test_videos/test (9).mp4"
cap = cv2.VideoCapture(VIDEO_PATH)
if not cap.isOpened():
    print("[ERROR] Video stream not opened.")
    exit()

print("[INFO] VISTA-X live stream started...")

# === Voice Assistant Setup (Emergency Only) ===
speak_text("VISTA-X system activated. Voice assistant will activate during emergencies.")
...
# === System Shutdown ===
speak_text("VISTA-X system shutting down. Drive safely!")
